...
namespace YMM43D.Scene3D
{
        ...
        float Depth)
    {
        ...
        /// Z=500 でちょうど 2 倍になったので、基準距離は 1000px です。
        /// </para>
        /// <para>
        /// この値は <see cref="SceneCamera"/> の既定のカメラ距離（10 単位 ＝
        /// <see cref="WorldScale.PixelsPerUnit"/> 換算で 1000px）と一致します。つまり
        /// 既定の設定では、YMM4 の 2D の遠近と 3D 側の投影がまったく同じ式になります。
        /// </para>
        /// </remarks>
