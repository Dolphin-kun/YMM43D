...
namespace YMM43D.Rendering.Geometries
{
    public class CubeGeometry : I3DGeometry
    {
        ...
        public CubeGeometry(ID3D11Device device)
        {
            ...
            // 頂点定義
            var vertices = new[] {
                new Vertex(new(-0.5f,  0.5f, -0.5f), new(1f, 0f, 0f, 1f), new(0f, 0f)), // 0: TL-Near
                new Vertex(new( 0.5f,  0.5f, -0.5f), new(0f, 1f, 0f, 1f), new(1f, 0f)), // 1: TR-Near
                new Vertex(new(-0.5f, -0.5f, -0.5f), new(0f, 0f, 1f, 1f), new(0f, 1f)), // 2: BL-Near
                new Vertex(new( 0.5f, -0.5f, -0.5f), new(1f, 1f, 0f, 1f), new(1f, 1f)), // 3: BR-Near
                new Vertex(new(-0.5f,  0.5f,  0.5f), new(1f, 0f, 1f, 1f), new(0f, 0f)), // 4: TL-Far
                new Vertex(new( 0.5f,  0.5f,  0.5f), new(0f, 1f, 1f, 1f), new(1f, 0f)), // 5: TR-Far
                new Vertex(new(-0.5f, -0.5f,  0.5f), new(1f, 1f, 1f, 1f), new(0f, 1f)), // 6: BL-Far
                new Vertex(new( 0.5f, -0.5f,  0.5f), new(0f, 0f, 0f, 1f), new(1f, 1f)), // 7: BR-Far
            };
